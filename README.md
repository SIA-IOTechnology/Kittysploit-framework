<div align="center">
  ...
  *Modular • Extensible • Powerful*
  ...
  [📖 Documentation](wiki/) • [🚀 Quick Start](#quick-start) • [💬 Discussions](https://github.com/SIA-IOTechnology/Kittysploit-framework/discussions)
</div>
...
> 1. Create a `docs/screenshots/` directory in your repository
> 2. Add your screenshot images (PNG, JPG, or GIF format recommended)
> 3. Update the paths above to match your screenshot filenames
> 4. Use relative paths: `docs/screenshots/your-image.png`
> 5. Or use absolute URLs: `https://raw.githubusercontent.com/user/repo/main/docs/screenshots/image.png`
...
<div align="center">
  ...
  [⭐ Star us on GitHub](https://github.com/SIA-IOTechnology/Kittysploit-framework) • [📖 Read the Docs](wiki/) • [💬 Join Discussions](https://github.com/SIA-IOTechnology/Kittysploit-framework/discussions)
</div>
