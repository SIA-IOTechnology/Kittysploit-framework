...
class Module(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("type IN ('exploits', 'auxiliary', 'scanner', 'post', 'payloads', 'workflow', 'listeners', 'browser_exploits', 'browser_auxiliary', 'docker_environment', 'encoders', 'backdoors', 'shortcut')", name='check_module_type'),
