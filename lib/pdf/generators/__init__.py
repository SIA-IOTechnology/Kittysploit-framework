...
from lib.pdf.generators.actions import write_gotoe_unc, write_gotoe_https, write_uri_action, write_launch_url, write_gotor_remote, write_submitform_html, write_import_data, write_gotoe_javascript_uri, write_uri_paren_injection, write_xobject_remote_url, write_thread_remote_filespec, write_launch_print_fetch, write_names_javascript_trigger, write_pdfium_openaction_uri, write_launch_win_cve
...
from lib.pdf.generators.xxe import write_xxe_xmp_metadata, write_xxe_xfa_acroform, write_xfa_xxe_oob, write_tika_xfa_xxe_oob, write_foxit_xxe_callback
