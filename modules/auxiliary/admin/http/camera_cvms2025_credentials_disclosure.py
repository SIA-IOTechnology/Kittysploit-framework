...
class Module(Auxiliary, Http_client):
    __info__ = {
        ...
        'description': 'Module exploits SIEMENS IP-Camera CCMS2025 Password Dislosure vulnerability. If target is vulnerable it is possible to read administrative credentials',
        'author': ['Yakir Wizman', 'VegetableCat'],
