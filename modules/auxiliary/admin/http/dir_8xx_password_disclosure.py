...
class Module(Auxiliary, Http_client):
    __info__ = {
        ...
        'description': 'Module exploits D-Link DIR-8XX password disclosure vulnerability, which allows retrieving administrative credentials.',
        'author': ['Hack2Win', 'Peter Geissler', 'Marcin Bury'],
        
        'platform': Platform.LINUX,
        'references': ['https://blogs.securiteam.com/index.php/archives/3310', 'https://blogs.securiteam.com/index.php/archives/3364', 'https://embedi.com/blog/enlarge-your-botnet-top-d-link-routers-dir8xx-d-link-routers-cruisin-bruisin'],
