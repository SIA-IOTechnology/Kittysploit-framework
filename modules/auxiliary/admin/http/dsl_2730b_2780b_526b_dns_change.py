...
class Module(Auxiliary, Http_client):
    __info__ = {
        ...
        'description': 'Module exploits D-Link DSL-2780B, DSL-2730B and DSL-526B dns change vulnerability. If the target is vulnerable it is possible to change dns settings.',
        'author': ['Todor Donev', 'Marcin Bury'],
        
        'platform': Platform.LINUX,
        'references': ['https://www.exploit-db.com/exploits/37237/', 'https://github.com/jh00nbr/Routerhunter-2.0'],
