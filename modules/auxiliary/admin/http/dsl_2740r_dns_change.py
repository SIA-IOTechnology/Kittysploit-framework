...
class Module(Auxiliary, Http_client):
    __info__ = {
        ...
        'description': 'Module exploits D-Link DSL-2740R dns change vulnerability. If the target is vulnerable it is possible to change dns settings.',
        'author': ['Todor Donev', 'Marcin Bury'],
        
        'platform': Platform.LINUX,
        'references': ['https://www.exploit-db.com/exploits/35917/', 'https://github.com/jh00nbr/Routerhunter-2.0'],
