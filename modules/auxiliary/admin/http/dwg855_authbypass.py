#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Technicolor DWG-855 Auth Bypass"""
...
class Module(Auxiliary, Http_client):
    __info__ = {
        ...
        'description': "Module exploits Technicolor DWG-855 Authentication Bypass vulnerability which allows changing administrator\\'s password. NOTE: This module will errase previous credentials, this is NOT stealthy.",
        'author': ['JPaulMora', '0BuRner'],
        
        'platform': Platform.LINUX,
        'references': ['Bug discovered some time before Aug 2016, this is the first reference to it!\nThis exploit works with any POST parameter, but changing admin creds gives you access to everything else.'],
