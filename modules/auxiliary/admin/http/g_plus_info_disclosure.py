...
class Module(Auxiliary, Http_client):
    __info__ = {
        ...
        'author': ['DarkFig', 'Marcin Bury'],
        'cve': ['CVE-2008-0403'],
        'platform': Platform.LINUX,
        'references': ['http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2008-0403', 'https://www.exploit-db.com/exploits/4941/'],
        'tags': ['iot', 'router', 'disclosure', 'credentials', 'unauth', 'cve-2008-0403', 'auxiliary'],
        'agent': {
            'risk': 'active',
