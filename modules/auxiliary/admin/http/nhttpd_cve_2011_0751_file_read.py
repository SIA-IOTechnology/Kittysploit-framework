#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Reads arbitrary files via CVE-2011-0751 /."""
...
class Module(Auxiliary, Http_client, Lfi):
    __info__ = {
        'name': 'nostromo nhttpd - Directory Traversal File Read (CVE-2011-0751)',
        'description': (
            'Reads arbitrary files via CVE-2011-0751 /..%2f traversal.'
        ),
        ...
        'tags': ['nhttpd', 'nostromo', 'lfi', 'file-read', 'unauth', 'cve-2011-0751'],
        'agent': {
            'risk': 'intrusive',
            ...
            'chain': {
                ...
                'option_bindings': {},
                'suggested_followups': ['scanner/http/cve_2011_0751_detect'],
            },
        },
    }
