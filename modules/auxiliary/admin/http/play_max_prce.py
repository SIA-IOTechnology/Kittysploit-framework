...
class Module(Auxiliary, Http_client):
    __info__ = {
        ...
        'author': ['BigNerd95 (Lorenzo Santina) https://github.com/bignerd95'],
        
        'platform': Platform.LINUX,
        'references': ['https://bignerd95.blogspot.it/2017/02/belkin-play-max-persistent-remote.html', 'https://gist.github.com/BigNerd95/c18658b472ac0ccf4dbbc73fe988b683'],
