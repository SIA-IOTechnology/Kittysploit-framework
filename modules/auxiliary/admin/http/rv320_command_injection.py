...
class Module(Auxiliary, Http_client):
    __info__ = {
        ...
        'author': ['RedTeam Pentesting GmbH', 'GH0st3rs'],
        'cve': ['CVE-2019-1652'],
        'platform': Platform.LINUX,
        'references': ['https://www.redteam-pentesting.de/en/advisories/rt-sa-2019-005/-cisco-rv320-command-injection', 'https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-1652', 'https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-20190123-rv-info'],
        'tags': ['iot', 'router', 'unauth', 'cve-2019-1652', 'auxiliary'],
        'agent': {
            'risk': 'active',
