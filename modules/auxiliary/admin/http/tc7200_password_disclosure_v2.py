#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Technicolor TC7200 Password Disclosure V2"""
...
class Module(Auxiliary, Http_client):
    __info__ = {
        ...
        'author': ['Gergely Eberhardt (@ebux25) from SEARCH-LAB Ltd. (www.search-lab.hu)', '0BuRner', 'Bastian Germann'],
        
        'platform': Platform.LINUX,
        'references': ['https://www.exploit-db.com/exploits/40157/', 'http://www.search-lab.hu/advisories/secadv-20160720'],
