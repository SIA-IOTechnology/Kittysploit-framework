...
class Module(Payload):
	...
	__info__ = {
		"name": "PowerShell HTTP Polling Beacon",
		"description": (
			"Native PowerShell HTTP polling implant compatible with "
			"listeners/multi/reverse_http_polling (jitter, kill date, working hours, cover traffic)"
		),
	...
	timezone = OptString("UTC", "Timezone (informational; local clock used)", False, True)
