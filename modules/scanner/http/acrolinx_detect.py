...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'Acrolinx Dashboard Detection',
        'description': 'An Acrolinx Analytics dashboard was detected.',
        'author': ['KittySploit Team'],
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'acrolinx'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://docs.acrolinx.com/coreplatform/latest/en/analytics/acrolinx-analytics-dashboards'],
    }
    ...
    def run(self):
        ...
        if any(m in body for m in markers):
            self.set_info(
                severity='info',
                reason="Acrolinx Dashboard detected",
                path='/dashboard.html',
            )
            return True
        return False
