...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'allied', 'allied_telesis'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://www.alliedtelesis.com/in/en'],
    }

    def run(self):
        r = self.http_request(method="GET", path='/public/login.html', allow_redirects=False)
        ...
        if body_hit:
            self.set_info(
                severity='info',
                reason="Allied Telesis Device GUI Login Panel detected",
