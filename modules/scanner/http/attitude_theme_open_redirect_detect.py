...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'WordPress Attitude 1.1.1 - Open Redirect Detection',
        ...
        'severity': 'medium',
        'tags': ['web', 'scanner', 'vulnerability', 'wordpress', 'wp-theme', 'redirect', 'vuln'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://cxsecurity.com/issue/WLB-2020030185'],
    }

    def run(self):
        r = self.http_request(method="GET", path='/wp-content/themes/Attitude/go.php?https://interact.sh/', allow_redirects=False)
        ...
        if (any(re.search(rx, headers, 0) for rx in header_regexes)):
            self.set_info(
                severity='medium',
                reason="WordPress Attitude 1.1.1 - Open Redirect detected",
