...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'axxon', 'vms', 'login', 'axxonsoft'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://www.axxonsoft.com/products/video-management-software'],
    }
    ...
    def run(self):
        ...
        if any(m in body for m in markers):
            self.set_info(
                severity='info',
                reason="Axxon Next Client Login detected",
                path='/',
            )
            return True
        return False
