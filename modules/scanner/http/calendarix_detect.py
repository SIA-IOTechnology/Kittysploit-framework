...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'calendarix', 'login'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        ...
        for path in ('/calendarix/admin/cal_login.php', '/calendar/admin/cal_login.php'):
            ...
            if any(m in body for m in markers):
                self.set_info(
                    severity='info',
                    reason="Calendarix Admin Login Panel detected",
                    path=path,
                )
                return True
        return False
