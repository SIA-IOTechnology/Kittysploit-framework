...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'references': ['https://www.exploit-db.com/ghdb/5669'],
    }

    def run(self):
        r = self.http_request(method="GET", path='/fmi/webd/', allow_redirects=False)
        ...
        if body_hit:
            self.set_info(
                severity='info',
                reason="Claris FileMaker WebDirect Panel detected",
                path='/fmi/webd/',
            )
            return True
        return False
