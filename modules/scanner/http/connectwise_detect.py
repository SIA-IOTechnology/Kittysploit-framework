#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Detects ConnectWise Control Remote Support Software Panel - Detect."""
...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'description': 'Detects ConnectWise Control Remote Support Software Panel - Detect.',
        'author': ['KittySploit Team'],
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'screenconnect', 'connectwise'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        ...
        if body_hit and any(m in headers for m in header_markers):
            self.set_info(
                severity='info',
                reason="ConnectWise Control Remote Support Software Panel detected",
                path='/Login',
            )
            return True
        return False
