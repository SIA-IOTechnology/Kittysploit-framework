...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'contentkeeper'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://www.contentkeeper.com/'],
    }

    def run(self):
        r = self.http_request(method="GET", path='/cgi-bin/ck/domenu.cgi', allow_redirects=False)
        ...
        if body_hit:
            self.set_info(
                severity='info',
                reason="ContentKeeper Cloud Panel detected",
