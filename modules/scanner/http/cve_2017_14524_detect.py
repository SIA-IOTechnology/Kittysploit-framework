#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""OpenText Documentum Administrator 7."""
...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'OpenText Documentum Administrator 7.2.0180.0055 - Open Redirect Detection',
        ...
        'severity': 'medium',
        'tags': ['web', 'scanner', 'cve', 'cve2017', 'redirect', 'opentext', 'seclists', 'vuln'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/xda/help/en/default.htm?startat=//oast.me', allow_redirects=False)
        ...
        if (any(re.search(rx, headers, 0) for rx in header_regexes)):
            self.set_info(
                severity='medium',
                reason="OpenText Documentum Administrator 7.2.0180.0055 - Open Redirect detected",
                path='/xda/help/en/default.htm?startat=//oast.me',
            )
            return True
        return False
