#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""VelotiSmart WiFi B-380 camera devices allow directory traversal via the uc-http service 1."""
...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'VelotiSmart Wifi - Directory Traversal Detection',
        ...
        'severity': 'critical',
        'tags': ['web', 'scanner', 'cve', 'cve2018', 'edb', 'lfi', 'camera', 'iot', 'velotismart_project', 'vuln'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        ...
        if (any(re.search(rx, body, 0) for rx in body_regexes)):
            self.set_info(
                severity='critical',
                reason="VelotiSmart Wifi - Directory Traversal detected",
                path='/../../etc/passwd',
            )
            return True
        return False
