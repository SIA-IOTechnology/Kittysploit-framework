...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'medium',
        'tags': ['web', 'scanner', 'cve', 'cve2018', 'iot', 'disclosure', 'edb', 'circarlife', 'scada', 'circontrol', 'vuln'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/html/device-id', allow_redirects=False)
        ...
        body_regexes = ('(19|20)\\d\\d[- /.](0[1-9]|1[012])[- /.](0[1-9]|[12][0-9]|3[01])',)
