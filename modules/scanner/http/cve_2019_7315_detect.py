#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Genie Access WIP3BVAF WISH IP 3MP IR Auto Focus Bullet Camera devices through 3."""
...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'Genie Access WIP3BVAF IP Camera - Local File Inclusion Detection',
        ...
        'severity': 'high',
        'tags': ['web', 'scanner', 'cve', 'cve2019', 'camera', 'genie', 'lfi', 'iot', 'genieaccess', 'vuln'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        ...
        if (any(re.search(rx, body, 0) for rx in body_regexes)):
            self.set_info(
                severity='high',
                reason="Genie Access WIP3BVAF IP Camera - Local File Inclusion detected",
                path='/../../../../../etc/passwd',
            )
            return True
        return False
