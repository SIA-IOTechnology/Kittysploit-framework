...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'Next.js <9.3.2 - Local File Inclusion Detection',
        ...
        'severity': 'medium',
        'tags': ['web', 'scanner', 'cve', 'cve2020', 'nextjs', 'lfi', 'zeit', 'vuln', 'vkev'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/_next/static/../server/pages-manifest.json', allow_redirects=False)
