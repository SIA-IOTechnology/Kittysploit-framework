#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""An issue was discovered in Zimbra Collaboration (ZCS) 9."""
...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'Zimbra Collaboration - Cross-Site Scripting (XSS) Detection',
        ...
        'severity': 'medium',
        'tags': ['web', 'scanner', 'cve', 'cve2024', 'zimbra', 'kev', 'passive', 'xss', 'vkev'],
        'agent': {
            'risk': 'active',
