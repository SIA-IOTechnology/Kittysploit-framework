...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'description': 'The DbGate Web Client Management Panel is detected on the target system.',
        'author': ['KittySploit Team'],
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'dbgate', 'oss'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://github.com/dbgate/dbgate'],
    }
    ...
    def run(self):
        ...
        if any(m in body for m in markers):
            self.set_info(
                severity='info',
                reason="DbGate Web Client Management - Panel Detect detected",
                path='/',
            )
            return True
        return False
