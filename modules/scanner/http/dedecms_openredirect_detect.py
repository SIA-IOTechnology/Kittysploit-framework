#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""DedeCMS contains an open redirect vulnerability."""
...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'DedeCMS - Open Redirect Detection',
        ...
        'severity': 'medium',
        'tags': ['web', 'scanner', 'vulnerability', 'dedecms', 'redirect', 'vuln'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://blog.csdn.net/ystyaoshengting/article/details/82734888'],
    }

    def run(self):
        r = self.http_request(method="GET", path='/plus/download.php?open=1&link=aHR0cHM6Ly9pbnRlcmFjdC5zaA==', allow_redirects=False)
        ...
        if (any(m in headers for m in header_any)):
            self.set_info(
                severity='medium',
                reason="DedeCMS - Open Redirect detected",
