#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Eko software update panel for embedded systems was detected."""
...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'references': ['https://ekoenergetyka.com.pl/software-solutions/'],
    }
    ...
    def run(self):
        ...
        if any(m in body for m in markers):
            self.set_info(
                severity='info',
                reason="Eko Software Update Panel detected",
                path='/',
            )
            return True
        return False
