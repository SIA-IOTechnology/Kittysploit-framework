...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'medium',
        'tags': ['web', 'scanner', 'exposure', 'config', 'svn', 'vuln'],
        'agent': {
            'risk': 'active',
