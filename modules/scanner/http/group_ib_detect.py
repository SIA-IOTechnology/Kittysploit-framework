...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'groupib'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://www.facebook.com/photo/?fbid=566951735475350&set=a.467014098802448'],
    }
    ...
    def run(self):
        ...
        if any(m in body for m in markers):
            self.set_info(
                severity='info',
                reason="Group-IB Managed XDR Login Panel detected",
                path='/login',
            )
            return True
        return False
