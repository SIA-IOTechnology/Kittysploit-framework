#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Hikvision's comprehensive security management platform has a Fastjson remote command execution vulnerability, ."""
...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'HIKVISION iSecure Center - Remote Code Execution Detection',
        'description': "Hikvision's comprehensive security management platform has a Fastjson remote command execution vulnerability, which can execute system commands and obtain system permissions and sensitive data information of the target server.",
        'author': ['KittySploit Team'],
        'severity': 'critical',
        'tags': ['web', 'scanner', 'hikvision', 'isecure', 'rce', 'vuln'],
        'agent': {
            'risk': 'active',
