...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'hp', 'ilo', 'hpe'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://www.hpe.com/us/en/servers/integrated-lights-out-ilo.html'],
    }

    def run(self):
        r = self.http_request(method="GET", path='/html/login.html', allow_redirects=False)
        ...
        if body_hit:
            self.set_info(
                severity='info',
                reason="Hewlett Packard Integrated Lights Out 5 Login Panel detected",
