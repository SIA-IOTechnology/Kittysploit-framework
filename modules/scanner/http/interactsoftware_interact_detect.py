#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Interact Software was detected."""
...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'interactsoftware', 'interact'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://www.interactsoftware.com'],
    }
    ...
    def run(self):
        ...
        if any(m in body for m in body_markers):
            self.set_info(
                severity='info',
                reason="Interact Software Panel detected",
                path='/login',
            )
            return True
        return False
