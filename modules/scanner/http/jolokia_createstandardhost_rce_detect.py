#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""File read and file write to RCE by deploying a vhost with MBeanFactory/createStandardHost and DiagnosticComman."""
...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'references': ['https://github.com/laluka/jolokia-exploitation-toolkit'],
    }
    ...
    def run(self):
        for path in ('/jolokia/list', '/actuator/jolokia/list'):
            ...
            if not r or r.status_code != 200:
                continue
            body = r.text or ""
            body_all = ('"desc":"Create a new StandardHost"', '"desc":"Array of Diagnostic Commands Arguments and Options"',)
