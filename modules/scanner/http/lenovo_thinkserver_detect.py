#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Lenovo ThinkServer System Manager login panel was detected."""
...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'thinkserver', 'lenovo'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        ...
        if any(m in body for m in markers):
            self.set_info(
                severity='info',
                reason="Lenovo ThinkServer System Manager Login Panel detected",
                path='/',
            )
            return True
        return False
