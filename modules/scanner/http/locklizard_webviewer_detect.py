...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'locklizard', 'webviewer'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://www.locklizard.com/pdf_security_webviewer/'],
    }
    ...
    def run(self):
        ...
        if any(m in body for m in markers):
            self.set_info(
                severity='info',
                reason="Locklizard Web Viewer Login Panel detected",
                path='/',
            )
            return True
        return False
