...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'magento'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://docs.magento.com/user-guide/stores/store-urls-custom-admin.html'],
    }
    ...
    def run(self):
        ...
        if any(m in body for m in markers):
            self.set_info(
                severity='info',
                reason="Magento Admin Login Panel detected",
                path='/admin',
            )
            return True
        return False
