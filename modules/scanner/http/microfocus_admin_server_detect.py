...
class Module(Scanner, Http_client):
    ...
    def run(self):
        for path in ('/', '/nps/servlet/portalservice', '/nds', '/_LOGIN_SERVER_'):
            ...
            body_markers = (
                ...
                'micro focus imonitor',
                'micro focus remote manager',
            ...
            if body_hit and any(m in headers for m in header_markers):
                self.set_info(
                    severity='info',
                    reason="Micro Focus Enterprise Server Admin Panel detected",
                    path=path,
                )
                return True
        return False
