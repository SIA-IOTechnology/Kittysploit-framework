...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'description': 'Netdata panel was discovered.',
        'author': ['KittySploit Team'],
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'netdata', 'login', 'dashboard'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://github.com/netdata/netdata', 'https://www.netdata.cloud/'],
    }
