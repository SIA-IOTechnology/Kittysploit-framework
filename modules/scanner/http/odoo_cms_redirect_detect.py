#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Odoo CMS contains an open redirect vulnerability."""
...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'Odoo CMS - Open Redirect Detection',
        ...
        'severity': 'medium',
        'tags': ['web', 'scanner', 'vulnerability', 'odoo', 'redirect', 'vuln'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/website/lang/en_US?r=https://interact.sh/', allow_redirects=False)
        ...
        if (any(re.search(rx, headers, 0) for rx in header_regexes)):
            self.set_info(
                severity='medium',
                reason="Odoo CMS - Open Redirect detected",
