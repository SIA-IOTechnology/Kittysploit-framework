...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'edb', 'olt'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://www.exploit-db.com/ghdb/8020'],
    }

    def run(self):
        r = self.http_request(method="GET", path='/action/login.html', allow_redirects=False)
        ...
        if body_hit:
            self.set_info(
                severity='info',
                reason="OLT Web Management Interface Login Panel detected",
