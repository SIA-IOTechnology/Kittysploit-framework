#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""ONLYOFFICE Community Server is a free open-source collaborative system developed to manage documents, projects."""
...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'onlyoffice'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        ...
        for path in ('/', '/auth.aspx'):
            ...
            if any(m in body for m in markers):
                self.set_info(
                    severity='info',
                    reason="ONLYOFFICE Login Panel detected",
                    path=path,
                )
                return True
        return False
