...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'openemr', 'open-emr'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/interface/login/login.php?site=default', allow_redirects=False)
        ...
        if False:
            self.set_info(
                severity='info',
                reason="OpenEMR Product Registration Panel detected",
