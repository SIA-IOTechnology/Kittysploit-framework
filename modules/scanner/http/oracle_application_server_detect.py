...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'oracle', 'containers', 'login'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://www.oracle.com/middleware/technologies/internet-application-server.html'],
    }

    def run(self):
        for path in ('/em/console/ias/oc4j/home', '/'):
            ...
            if any(m in body for m in body_markers):
                self.set_info(
                    severity='info',
                    reason="Oracle Application Server Panel detected",
                    path=path,
                )
                return True
        return False
