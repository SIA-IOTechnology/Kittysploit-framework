...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'edb', 'pandorafms'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://www.exploit-db.com/ghdb/6827'],
    }

    def run(self):
        r = self.http_request(method="GET", path='/pandora_console/mobile/', allow_redirects=False)
        ...
        if any(m in body for m in markers):
            self.set_info(
                severity='info',
                reason="Pandora FMS Mobile Console Login Panel detected",
