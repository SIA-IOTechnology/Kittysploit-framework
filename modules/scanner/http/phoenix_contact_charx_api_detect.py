...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'description': 'Phoenix Contact CHARX SEC-3XXX AC Charging Controller REST API was detected.',
        'author': ['KittySploit Team'],
        'severity': 'info',
        'tags': ['web', 'scanner', 'exposure', 'phoenix-contact', 'charx', 'ics', 'api'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        ...
        if (all(m in body for m in body_all)):
            self.set_info(
                severity='info',
                reason="Phoenix Contact CHARX SEC-3XXX AC Charging Controller REST API detected",
