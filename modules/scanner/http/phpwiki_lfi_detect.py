...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'phpwiki 1.5.4 - Cross-Site Scripting/Local File Inclusion Detection',
        ...
        'severity': 'high',
        'tags': ['web', 'scanner', 'vulnerability', 'xss', 'edb', 'phpwiki', 'lfi', 'vuln'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/phpwiki/index.php/passwd', allow_redirects=False)
        ...
        if (any(re.search(rx, body, 0) for rx in body_regexes)):
            self.set_info(
                severity='high',
                reason="phpwiki 1.5.4 - Cross-Site Scripting/Local File Inclusion detected",
