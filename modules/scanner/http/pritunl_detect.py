...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'Pritunl - Panel Detection',
        'description': 'Realtime website and application monitoring tool',
        'author': ['KittySploit Team'],
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'pritunl', 'login'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://github.com/louislam/uptime-kuma', 'https://uptime.kuma.pet/docs/'],
    }
