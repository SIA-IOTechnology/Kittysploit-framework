...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'radius', 'edb'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://www.exploit-db.com/ghdb/6790'],
    }
    ...
    def run(self):
        ...
        for path in ('/', '/admin.php', '/radiusmanager/user.php', '/user.php'):
            ...
            if any(m in body for m in markers):
                self.set_info(
                    severity='info',
                    reason="Radius Manager Admininstration Control Panel Login Panel detected",
                    path=path,
                )
                return True
        return False
