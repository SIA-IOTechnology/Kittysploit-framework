#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Reliable Controls MACH-ProWebSys is a web-based building controller for HVAC, lighting, and energy management ."""
...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'Reliable Controls MACH-Pro - Login Panel Detection',
        ...
        'references': ['https://reliablecontrols.com/products/mach-prowebsys/'],
    }
    ...
    def run(self):
        ...
        markers = (
            'Reliable Controls',
            'Reliable Controls Embedded Web Server',
            'mpw-sw',
        )
        if any(m in body for m in markers):
            self.set_info(
                severity='info',
                reason="Reliable Controls MACH-Pro - Login Panel detected",
                path='/',
            )
            return True
        return False
