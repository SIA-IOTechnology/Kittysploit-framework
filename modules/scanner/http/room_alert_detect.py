...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'room-alert', 'avtech'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://avtech.com/articles/166/how-to-access-a-room-alert-monitors-settings-pages-2/'],
    }

    def run(self):
        for path in ('/index.html', '/gateway'):
            ...
            if body_hit:
                self.set_info(
                    severity='info',
                    reason="AVTECH Room Alert Login Panel detected",
                    path=path,
                )
                return True
        return False
