...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'scs', 'rmc', 'iot'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://www.scsengineers.com/services/remote-monitoring-control/'],
    }
    ...
    def run(self):
        ...
        if any(m in body for m in markers):
            self.set_info(
                severity='info',
                reason="SCS Remote Monitoring and Control Login Panel detected",
                path='/',
            )
            return True
        return False
