...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'Webbdesign SL-Studio - Local File Inclusion Detection',
        'description': 'Webbdesign SL-Studio is vulnerable to local file inclusion.',
        'author': ['KittySploit Team'],
        'severity': 'high',
        'tags': ['web', 'scanner', 'vulnerability', 'slstudio', 'lfi', 'vuln'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://cxsecurity.com/issue/WLB-2018110187'],
    }
    ...
    def run(self):
        ...
        if (any(re.search(rx, body, 0) for rx in body_regexes)):
            self.set_info(
                severity='high',
                reason="Webbdesign SL-Studio - Local File Inclusion detected",
