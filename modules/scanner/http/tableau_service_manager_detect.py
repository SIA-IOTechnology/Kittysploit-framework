...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'tableau', 'tableausoftware'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://help.tableau.com/current/server/en-us/sign_in_tsm.htm'],
    }
    ...
    def run(self):
        ...
        if any(m in body for m in markers):
            self.set_info(
                severity='info',
                reason="Tableau Services Manager Login Panel detected",
                path='/',
            )
            return True
        return False
