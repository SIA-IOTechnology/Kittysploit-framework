...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'totemomail', 'totemo'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://www.totemo.com/en/products/email-encryption'],
    }
    ...
    def run(self):
        ...
        for path in ('/responsiveUI/', '/responsiveUI/webmail/folder.xhtml'):
            ...
            if any(m in body for m in markers):
                self.set_info(
                    severity='info',
                    reason="Totemomail Login Panel detected",
                    path=path,
                )
                return True
        return False
