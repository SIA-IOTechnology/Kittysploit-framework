...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'login', 'truenas', 'ixsystems'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://www.truenas.com'],
    }

    def run(self):
        r = self.http_request(method="GET", path='/ui/sessions/signin', allow_redirects=False)
