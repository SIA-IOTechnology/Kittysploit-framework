...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'references': ['https://www.facebook.com/ExWareLabs/photos/a.361854183878462/5538760399521122'],
    }
    ...
    def run(self):
        ...
        if body_hit:
            self.set_info(
                severity='info',
                reason="V2924 Admin Login Panel detected",
                path='/',
            )
            return True
        return False
