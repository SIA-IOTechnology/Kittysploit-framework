...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'vaultwarden', 'login'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://github.com/dani-garcia/vaultwarden'],
    }
    ...
    def run(self):
        ...
        markers = (
            'vaultwarden web</title>',
        )
        if any(m in body for m in markers):
            self.set_info(
                severity='info',
                reason="Vaultwarden Login Panel detected",
                path='/#/login',
            )
            return True
        return False
