#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""vBulletin is a proprietary forum and community publishing software written in PHP."""
...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'info',
        'tags': ['web', 'scanner', 'technology', 'tech', 'vbulletin'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        ...
        body_markers = ('powered by vbulletin', 'content="vbulletin', 'id="vbulletin_css',)
        if any(m in body for m in body_markers):
            self.set_info(
                severity='info',
                reason="vBulletin detected",
                path='/',
            )
            return True
        return False
