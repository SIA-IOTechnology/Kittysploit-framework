...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'Vue PACS - Panel Detection',
        'description': 'Vue PACS was detected.',
        'author': ['KittySploit Team'],
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'vue', 'pacs', 'login', 'philips'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/portal/WebLogin.aspx', allow_redirects=False)
