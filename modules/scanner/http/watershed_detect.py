...
class Module(Scanner, Http_client):
    __info__ = {
        ...
        'severity': 'info',
        'tags': ['web', 'scanner', 'panel', 'watershed'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        r = self.http_request(method="GET", path='/app/outside.html#/signin', allow_redirects=False)
        ...
        if body_hit:
            self.set_info(
                severity='info',
                reason="Watershed Login Panel detected",
