#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""WordPress Knews Multilingual Newsletters 1."""
...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'WordPress Knews Multilingual Newsletters 1.1.0 - Cross-Site Scripting Detection',
        ...
        'severity': 'high',
        'tags': ['web', 'scanner', 'wordpress', 'xss', 'wp-plugin', 'vuln'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        ...
        if not r or r.status_code != 200:
            return False
        body = r.text or ""
        body_any = ('Knews Multilingual Newsletters',)
        ...
        if (any(m in body for m in body_any)) and (any(m in headers for m in header_any)):
            self.set_info(severity='high', reason='WordPress Knews Multilingual Newsletters 1.1.0 - Cross-Site Scripting detected', path=path)
            return True
        return False
