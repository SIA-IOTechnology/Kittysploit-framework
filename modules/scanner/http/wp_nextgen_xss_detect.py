...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'WordPress NextGEN Gallery 1.9.10 - Cross-Site Scripting Detection',
        ...
        'severity': 'high',
        'tags': ['web', 'scanner', 'wp-plugin', 'edb', 'wordpress', 'xss', 'vuln'],
        'agent': {
            'risk': 'active',
    ...
    def run(self):
        ...
        if (any(m in body for m in body_any)) and (any(m in headers for m in header_any)):
            self.set_info(severity='high', reason='WordPress NextGEN Gallery 1.9.10 - Cross-Site Scripting detected', path=path)
            return True
        return False
