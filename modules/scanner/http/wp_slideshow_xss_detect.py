#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""WordPress Slideshow plugin contains multiple cross-site scripting vulnerabilities."""
...
class Module(Scanner, Http_client):
    __info__ = {
        'name': 'WordPress Slideshow - Cross-Site Scripting Detection',
        ...
        'severity': 'high',
        'tags': ['web', 'scanner', 'wordpress', 'xss', 'wp-plugin', 'edb', 'vuln'],
        'agent': {
            'risk': 'active',
        ...
        'references': ['https://www.exploit-db.com/exploits/37948'],
    }
    ...
    def run(self):
        ...
        if (any(m in body for m in body_any)) and (any(m in headers for m in header_any)):
            self.set_info(severity='high', reason='WordPress Slideshow - Cross-Site Scripting detected', path=path)
            return True
        return False
