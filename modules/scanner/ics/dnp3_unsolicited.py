...
class Module(Scanner, Ics_scanner_client):
    ...
    'agent': {
        ...
        'requires':         {'min_endpoints': 0,
         ...
         'risk_signals_any': [],
         'auth_session': False,
         'capabilities_any': ['ot_assets', 'dnp3_access'],
         'capabilities_all': [],
         'confidence_min': {},
         'confidence_min_any': {},
        ...
        'chain':         {'produces_capabilities': [{'capability': 'dnp3_access', 'from_detail': ''}, {'capability': 'ot_assets', 'from_detail': ''}, {'capability': 'ssrf_primitive', 'from_detail': ''}],
