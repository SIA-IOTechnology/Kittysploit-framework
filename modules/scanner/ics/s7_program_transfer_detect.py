...
class Module(Scanner, Ics_scanner_client):
    ...
    'agent': {
        ...
        'requires':         {'min_endpoints': 0,
         ...
         'risk_signals_any': [],
         'auth_session': False,
         'capabilities_any': ['ot_assets', 's7comm'],
         'capabilities_all': [],
         'confidence_min': {},
         'confidence_min_any': {},
        ...
        'chain':         {'produces_capabilities': [{'capability': 'ot_assets', 'from_detail': ''}, {'capability': 'ssrf_primitive', 'from_detail': ''}, {'capability': 's7comm', 'from_detail': ''}],
